    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className={`absolute inset-0 transition-all duration-1000 ${
        ...
        <div className="absolute inset-0">
          ...
          {/* Orb 2 */}
          <div className={`absolute w-[500px] h-[500px] rounded-full opacity-15 blur-3xl animate-pulse ${
          ...
          {/* Orb 3 */}
          <div className={`absolute w-80 h-80 rounded-full opacity-10 blur-3xl animate-pulse ${
          ...
          {/* Additional Orbs for Full Width Coverage */}
          <div className={`absolute w-64 h-64 rounded-full opacity-15 blur-3xl animate-pulse ${
          ...
          <div className={`absolute w-72 h-72 rounded-full opacity-12 blur-3xl animate-pulse ${
          ...
          <div className={`absolute w-80 h-80 rounded-full opacity-8 blur-3xl animate-pulse ${
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className={`w-full max-w-md p-8 rounded-2xl shadow-2xl backdrop-blur-md transition-all duration-500 transform hover:scale-105 ${
          isDark 
