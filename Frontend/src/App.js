...
import { Calendar, MapPin, Users, Clock, Menu, X, Sun, Moon, Search, Filter, Star, User, Settings, LogOut, Home, Building, BookOpen, ChevronLeft, ChevronRight, Wifi, Coffee, Monitor, Phone } from 'lucide-react';
      ...
      <div className={`w-full max-w-md p-8 rounded-2xl shadow-xl ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className={`mt-4 w-full flex items-center justify-center gap-3 px-4 py-3 border rounded-lg font-medium transition-colors ${
              isDark 
    ...
    return (
      <div className="p-6">
        <div className="animate-pulse">
          <div className={`h-8 w-64 rounded mb-4 ${isDark ? 'bg-gray-700' : 'bg-gray-200'}`}></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1,2,3,4,5,6].map(i => (
              <div key={i} className={`p-6 rounded-xl border ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <div className={`h-4 w-3/4 rounded mb-2 ${isDark ? 'bg-gray-700' : 'bg-gray-200'}`}></div>
...
const Bookings = () => {
  ...
  const bookings = {
    upcoming: [
      { id: 1, space: 'Conference Room A', date: '2025-07-01', time: '09:00 - 11:00', price: 75, status: 'confirmed' },
      { id: 2, space: 'Hot Desk #12', date: '2025-07-02', time: '14:00 - 18:00', price: 25, status: 'pending' },
    ],
    past: [
      { id: 3, space: 'Phone Booth 2', date: '2025-06-29', time: '10:30 - 11:30', price: 15, status: 'completed' },
      { id: 4, space: 'Hot Desk #5', date: '2025-06-28', time: '09:00 - 17:00', price: 25, status: 'completed' },
    ],
  };
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${isDark ? 'bg-gray-700' : 'bg-gray-100'}`}>
                  <Building className={`w-6 h-6 ${isDark ? 'text-gray-400' : 'text-gray-600'}`} />
                </div>
                <div>
...
const Community = () => {
  ...
  const events = [
    { id: 1, title: 'Networking Coffee', date: '2025-07-03', time: '10:00 AM', attendees: 12, maxAttendees: 20 },
    { id: 2, title: 'Tech Talk: AI in Workspace', date: '2025-07-05', time: '2:00 PM', attendees: 25, maxAttendees: 30 },
    { id: 3, title: 'Friday Happy Hour', date: '2025-07-07', time: '5:00 PM', attendees: 18, maxAttendees: 25 },
  ];

  const members = [
    { id: 1, name: 'Sarah Chen', role: 'Product Designer', company: 'TechCorp' },
    { id: 2, name: 'Mike Johnson', role: 'Software Engineer', company: 'StartupXYZ' },
    { id: 3, name: 'Lisa Park', role: 'Marketing Manager', company: 'BrandCo' },
    { id: 4, name: 'David Kim', role: 'Data Scientist', company: 'Analytics Inc' },
  ];
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className={`${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
          Connect with fellow workspace members and join events.
        </p>
      </div>
